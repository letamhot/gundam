                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <a type="button" class="sorting" data-sorting_type="asc"
                                                    data-column_name="userName" style="cursor: pointer"> Tên người dùng</a>
                                                <span id="userName_icon"></span>
                                            </th>
                                            <th>
                                                <a type="button" class="sorting" data-sorting_type="asc"
                                                    data-column_name="phone" style="cursor: pointer">Số điện thoại</a>
                                                <span id="phone_icon"></span>
                                            </th>
                                            <th>
                                                <a type="button" class="sorting" data-sorting_type="asc"
                                                    data-column_name="address" style="cursor: pointer"> Địa chỉ</a>
                                                <span id="address_icon"></span>
                                            </th>
                                            <th>
                                                <a type="button" class="sorting" data-sorting_type="asc"
                                                    data-column_name="priceTotal" style="cursor: pointer">Tổng tiền</a>
                                                <span id="priceTotal_icon"></span>
                                            </th>
                                            <th>Trạng thái</th>
                                            <th>Mã giảm giá</th>
                                    ...
                                    <tbody>
                                        @include('admin.bill.dataBill')
                                    </tbody>
                                </table>
                                <input type="hidden" name="hidden_page" id="hidden_page" value="1" />
                                <input type="hidden" name="hidden_column_name" id="hidden_column_name" value="phone" />
...
<script>
    $(document).ready(function() {
        function clear_icon() {
            ...
            $('#phone_icon').html('');
            $('#address_icon').html('');
            $('#priceTotal_icon').html('');
        }

        function fetch_data(page, sort_type, sort_by, query) {
            $.ajax({
                url: "/admin/bill/dataBill?page=" + page + "&sortby=" + sort_by + "&sorttype=" +
