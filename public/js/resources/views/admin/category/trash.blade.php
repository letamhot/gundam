...
@section('title', 'Thùng rác loại hàng')
@section('content')
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Thùng rác loại hàng</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Trang admin</a></li>
                        <li class="breadcrumb-item active">Thùng rác loại hàng</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                                ...
                                <table class="table table-striped table-bordered" width="100%" cellspacing="0">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>
                                                <a type="button" class="sorting" data-sorting_type="asc" data-column_name="name" style="cursor: pointer"> </a>
                                                <span id="name_icon"></span>
                                            </th>
                                            
                                            <th>Chi tiết tên loại hàng</th>
                                            <th colspan="2">Hoạt động</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                       @include('admin.category.trashData')
                                    </tbody>
                                </table>
...
<script>
       $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"/admin/category/dataTrash?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
