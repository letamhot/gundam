            ...
            <div class="col-lg-6 offset-lg-3">
                <div class="login-form">
                    ...
                    <form action="{{ route('details.store') }}" method="POST">
                        ...
                        <br>
                        <button type="submit" class="site-btn login-btn btn btn-success">Đổi mật khẩu</button>
                        <a href="{{ route('details.profile') }}" style="float:right" class="or-login btn btn-danger">Thoát</a>
                    </form>
