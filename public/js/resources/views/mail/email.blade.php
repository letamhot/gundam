<table cellpadding="0" cellspacing="0" style="border-radius:4px;border:1px #dceaf5 solid" border="0" align="center">
    <tbody>
        ...
        <tr style="line-height:0px">
            <td width="100%" style="font-size:0px" align="center" height="1"><img src="https://files.couponannie.com/stores/original/watch-sale-online.jpg"
                            ...
                            <td width="454" align="left"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-size:24px;font-weight:300;line-height:32px" align="center">
                                                <b style="color: #ee4d2d">Đồng hồ chính hãng<br>Phong cách thời đại</b></td>
                                        </tr>
                                    </tbody>
                                </table>
                                <br>
                                <a href="https://www.dropbox.com/l/AACM1bItR5RN3-XIuVzPXkiT0fRhAqQey7w/downloading"
                                    ...
                                    <center><img width="100%" style="max-width:300px"
                                            src="https://s1.storage.5giay.vn/image/2017/08/20170826_30f2918a3b89804e9bbbf6e664ffcd73_1503719484.jpg"
                                            class="CToWUd"></center>
                                </a><br><b>Dear {{ $contact->name }} </b>. Thanks for your feedback. <br>
                                {!! $mess !!}
                                <b>
                                    <ul>
                                        <li>Start Something New on <a href="{{ route('gumdamstore') }}" target="_blank"
                                                data-saferedirecturl="">shopwatch.net</a>
                                        </li>
                                ...
                                <center><a
                                        ...
                                        href="{{ route('gumdamstore') }}" target="_blank" data-saferedirecturl="">Go
