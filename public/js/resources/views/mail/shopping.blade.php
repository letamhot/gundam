                                                    ...
                                                    <td width="454" align="left"
                                                        ...
                                                        <a href="https://www.dropbox.com/l/AACM1bItR5RN3-XIuVzPXkiT0fRhAqQey7w/downloading"
                                                            ...
                                                            <center><img width="100%" style="max-width:300px"
                                                                    src="https://files.couponannie.com/stores/original/watch-sale-online.jpg"
                                                                    class="CToWUd"></center>
                                                        </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="left" valign="middle"
                                        ...
                                        Hi {{ $order->user['name'] }},
                                        <br> Thank you for shopping at WatchSale
                                        <br>
                                        <br> Your order is
                                        <b> waiting shop</b>
                                        ...
                                        <table style="width:100%" cellpadding="0" cellspacing="0" border="0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top"
                                                        style="font-family:Arial,Helvetica,sans-serif;font-size:12px;color:#666666;line-height:20px;padding-left:10px;padding-bottom:5px">
                                                        {{ number_format($order->priceTotal, 2) }} VND &nbsp;
                                        ...
                                        <b>
                                            <ul>
                                                <li>Start Something New on <a href="{{ route('gumdamstore') }}"
                                                        target="_blank"
                                                        data-saferedirecturl="">donghochinhhang.com</a>
                                                </li>
