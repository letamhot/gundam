                ...
                <table class="table table-condensed">
                    <thead>
                        <tr class="cart_menu">
                            ...
                            <td class="product" width='20%'>Sản phẩm</td>
                            ...
                            <td class="update"> Sửa số lượng</td>
            ...
            <div class="col-lg-4">
                <div class="cart-buttons">
                    ...
                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                        data-target="#myModal">Thay đổi</button>
                    <br><br>
        ...
        <form action="{{ route('change_address') }}" method="POST">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>Địa chỉ gửi hàng: <input type="text" placeholder="Address" name="address"
                            class="form-control">
                    </p>
                </div>
                <div class="modal-footer">
