                    ...
                    <div class="col-sm-8">
                        <div class="shop-menu pull-right">
                            <ul class="nav navbar-nav">
                                ...
                                @if(!Auth::user())
                                <li><a href="{{ url('loginWatch') }}"><i class="fa fa-lock"></i> Đăng nhập</a></li>
                                @endif
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-9">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="{{ route('cart') }}">Giỏ hàng</a>
                                </li>
                                <li class="dropdown"><a href="#">Sản phẩm<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{ route('shop') }}">danh sách sản phẩm</a></li>

                                    </ul>
                                </li>
                                @if(Auth::user())
                                <li><a href="{{ url('logout') }}" class="login-panel">Đăng xuất</a></li>
                                @endif
