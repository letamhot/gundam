                                ...
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordian" href="#mens">
                                        <span class="badge pull-right"><i
                                                class="fa fa-plus"></i></span>{{ $categories->name }}
                                    </a>
                                </h4>
                            </div>
                            ...
                            <!-- Wrapper for slides -->
                              <div class="carousel-inner">
                                  <div class="item active">
                                    <a href=""><img src="{{asset(Storage::url( $id_product->image )) }}" alt="" width="85px" height="85px"></a>
                                    <a href=""><img src="{{asset(Storage::url( $id_product->image1 )) }}" alt="" width="85px" height="85px"></a>
                                    <a href=""><img src="{{asset(Storage::url( $id_product->image2 )) }}" alt="" width="85px" height="85px"></a>
                                  </div>
                                  <div class="item ">
                                    <a href=""><img src="{{asset(Storage::url( $id_product->image )) }}" alt="" width="85px" height="85px"></a>
                                    <a href=""><img src="{{asset(Storage::url( $id_product->image1 )) }}" alt="" width="85px" height="85px"></a>
                            ...
                            @if($id_product->size_product->sum('qty') < 1) <h2
                               ...
                               Hết hàng</h2>
                                ...
                                <div class="sc-item">
                                    ...
                                    <div>
                                        ...
                                        <div class="sc-item" style="font-weight: bold; color: #757575">
                                            <span class="{{ $size_name->size->name }} qtyavailable">{{ $size_name->qty . " sản phẩm có sẵn " }}</span>
                                        </div>
                                ...
                                <p style="padding-top: 20px;" id="quantity" name="qty"><b>Số lượng:</b>
                                    {{ $id_product->size_product->sum('qty') }} sản phẩm</p>
                                <p><b>Status:
                                        @if( $id_product->new == 1)
                                    </b> Mới</p>
                                @else
                                    ...
                                    <div class="single-products">
                                        <div class="productinfo text-center">
                                            <a href="{{ route('productdetail', $product->id) }}">
                                                ...
                                                <img src="{{asset(Storage::url( $id_product->image )) }}" alt="" /></a>
                                            @else
                                            <img src="{{asset(Storage::url( $id_product->image )) }}" alt=""
                            ...
                            <div class="specification-table">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="p-stock">{{ $id_product->size_product->sum('qty') }} trong kho
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                            ...
                                            <div class="productinfo text-center">
                                                <a href="{{ route('productdetail', $item->id) }}">
                                                    ...
                                                    <img src="{{asset(Storage::url( $id_product->image )) }}" alt=""
                                                        height="180px" /></a>
                                                @else
                                                <img src=" {{asset(Storage::url( $id_product->image )) }}" alt="" height="180px"
                                                    style="-webkit-filter: blur(2px);" /></a>
                                                @endif
                                                @if($item->size_product->sum('qty') > 0)
                                                ...
                                                <h2><span style="color:red">Hết hàng</span> <br>
                                                    <span
                                                        style="color: #b2b2b2; text-decoration: line-through">{{ number_format($item->price) }}
                                                        VND</span></h2>
