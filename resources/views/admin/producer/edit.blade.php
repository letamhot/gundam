...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Sửa thông tin nhà phân phối: {{$producer->name}}</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="invoice p-3 mb-3">
                        <form action="{{route('admin.producer.update', $producer->id)}}" method="Post" enctype="multipart/form-data">
                            @csrf
                            @method('put')
