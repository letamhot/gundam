...
@section('title', 'Thùng rác nhà phân phối')
@section('content')
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Thùng rác nhà phân phối</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Trang admin</a></li>
                        <li class="breadcrumb-item active">Thùng rác nhà phân phối</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                       @include('admin.producer.trashData')
                                    </tbody>
                                </table>
...
<script>
       $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"/admin/producer/producerTrashData?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
