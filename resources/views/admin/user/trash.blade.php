...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0 text-dark">Danh sách người dùng trong thùng rác</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="callout callout-info">
                        ...
                        <form action="{{route('admin.user.trash')}}" method="GET" class="input-group input-group-sm col-5" style="float: right;">
...
<script>
       $(document).ready(function(){
            ...
            {
                $.ajax({
                    url:"/admin/user/dataTrash?page="+page+"&sortby="+sort_by+"&sorttype="+sort_type+"&query="+query,
