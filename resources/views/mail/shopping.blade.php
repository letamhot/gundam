                            ...
                            <tbody>
                                ...
                                <tr style="line-height:0px">
                                    <td width="100%" style="font-size:0px" align="center" height="1"><img
                                            src="https://e7.pngegg.com/pngimages/357/694/png-clipart-gn-001-gundam-exia-gn001-gundam-exia-sports-equipment-fictional-character.png"
                                                    ...
                                                    <td width="454" align="left"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    <td style="font-size:24px;font-weight:300;line-height:32px"
                                                                        align="center">
                                                                        <b style="color: #ee4d2d">Gundam<br>Mô hình hiện đại</b></td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <br>
                                                        <a href="https://www.dropbox.com/l/AACM1bItR5RN3-XIuVzPXkiT0fRhAqQey7w/downloading"
                                                            ...
                                                            <center><img width="100%" style="max-width:300px"
                                                                    src="https://img.favpng.com/21/19/14/mobile-suit-gundam-gundam-vs-gundam-gundam-model-gn-002-gundam-dynames-png-favpng-vxCJN3YK5a8FFD0BEY0qiZwT4_t.jpg"
                                                                    class="CToWUd"></center>
                                                        </a>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td align="left" valign="middle"
                                        ...
                                        Hi {{ $order->user['name'] }},
                                        <br> Thank you for shopping at GunDam
                                        <br>
                                        <br> Your order is
                                        <b> waiting shop</b>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="left" valign="top"
                                                        ...
                                                        @if(($item->price * $order->bill_detail->sum('quantity'))
                                                        > $order->priceTotal)
                                                        <span
                                                            style="text-decoration: line-through; font-size: 11px; font-weight:400; color: #b2b2b2;">
                                                            {{ ($item->unit_price * $order->bill_detail->sum('quantity')) }}VND
                                                        </span>
                                                        @endif
                            ...
                            <tbody>
                                <tr>
                                    <td align="center" valign="middle"
                                        ...
                                        <b>
                                            <ul>
                                                <li>Start Something New on <a href="{{ route('gumdamstore') }}"
                                                        target="_blank"
                                                        data-saferedirecturl="">gundam.net</a>
                                                </li>
                                        ...
                                        <center><a
                                                ...
                                                href="{{ route('gumdamstore') }}" target="_blank"
